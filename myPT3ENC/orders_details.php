...
<head>
  ...
  <title>Nerf Pawn Shop : Order Details</title>
  <!-- Bootstrap -->
  ...
  <style type="text/css">
    ...
    * {box-sizing: border-box}
    ...
    /* Style for Order Date input field */
    input[type=date] {
        width: 100%;
        padding: 12px;
 ...
 <?php include_once 'nav_bar.php'; ?>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a196330, tbl_staff_a196330,
          tbl_customers_a196330 WHERE
          tbl_orders_a196330.fld_staff_num = tbl_staff_a196330.FLD_STAFF_ID AND
 ...
 <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          ?>
         <option value="<?php echo $productrow['prod_id']; ?>"><?php echo $productrow['prod_type']." ".$productrow['prod_name']; ?></option>
          <?php
          }
          $conn = null;
          ?>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM tbl_orders_details_a196330,
            tbl_products_a196330 WHERE
            tbl_orders_details_a196330.fld_product_num = tbl_products_a196330.prod_id AND
          fld_order_num = :oid");
          $stmt->bindParam(':oid', $oid, PDO::PARAM_STR);
          $oid = $_GET['oid'];
        $stmt->execute();
