...
<head>
  ...
  <title>Nerf Pawn Shop : Products Details</title>
  <!-- Bootstrap -->
...
<div class="container-fluid">
  <div class="row" id = "target">
    <div class="col-xs-12 col-sm-5 col-sm-offset-1 col-md-4 col-md-offset-2 well well-sm text-center">
      <?php if ($readrow['prod_image'] == "" ) {
        echo "No image";
      }
      else { ?>
      <img src="products/<?php echo $readrow['prod_image'] ?>" class="img-responsive">
      <?php } ?>
    </div>
    <div class="col-xs-12 col-sm-5 col-md-4">
      ...
      <table class="table">
        ...
        <tr>
          ...
          <td>RM <?php echo $readrow['prod_price'] ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php echo $readrow['prod_quantity'] ?></td>
        </tr>
        <tr>
          <td><strong>Image</strong></td>
          <td><?php echo $readrow['prod_image'] ?></td>
        </tr>
      </table>
      </div>
    </div>
